            ...
            if (typeof currentLrc === 'string') {
                ...
                if (isQrcResult) {
                    try {
                        ...
                        if (Array.isArray(qrcParsed) && qrcParsed.some(function(l) { return l.trans; })) {
                            ...
                            localStorage.setItem('am_lyric_' + currentTrackId, injectedLrc);
                ...
                if (injectedLrc && injectedLrc !== currentLrc && injectedLrc.trim() !== '' &&
                    ...
                    if (!box || box.children.length === 0) {
                        ...
                        localStorage.setItem('am_lyric_' + currentTrackId, currentLrc);
                ...
                if (hasAny) {
                    localStorage.setItem('am_lyric_' + currentTrackId, JSON.stringify(currentLrc));
...
${numberedLyrics.substring(0, 7000)}`;
        ...
        localStorage.setItem('am_lyric_' + currentTrackId, newLrc);
